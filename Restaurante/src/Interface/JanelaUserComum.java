 ...
 * @author Rafael
 */
public class JanelaUserComum extends javax.swing.JFrame {

    /**
     * Creates new form JanelaUserComum
     */
    public JanelaUserComum() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JanelaUserComum.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JanelaUserComum().setVisible(true);
            }
        });
    }
